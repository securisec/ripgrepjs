...
class RipGrep {
	 ...
	 * @memberof RipGrep
	 */
	constructor (pattern: string, path: string, rgPath = 'rg') {
	...
	run = (): RipGrep => {
		...
		try {
			this.output = execSync(rgCommand).toString();
		} catch (error) {
	 ...
	 * @returns {RipGrep}
	 */
	afterContext = (num: number): RipGrep => {
	 ...
	 * @returns {RipGrep}
	 */
	beforeContext = (num: number): RipGrep => {
	 ...
	 * @returns {RipGrep}
	 */
	color = (when: 'never' | 'auto' | 'aways' | 'ansi'): RipGrep => {
	 ...
	 * @returns {RipGrep}
	 */
	colors = (colorSpec: string): RipGrep => {
	 ...
	 * @returns {RipGrep}
	 */
	contextSeparator = (separator: string): RipGrep => {
	 ...
	 * @returns {RipGrep}
	 */
	dfaSizeLimit = (num_suffix: string): RipGrep => {
	 ...
	 * @returns {RipGrep}
	 */
	encoding = (encoding: string): RipGrep => {
	 ...
	 * @returns {RipGrep}
	 */
	ignoreFile = (path: string): RipGrep => {
	 ...
	 * @returns {RipGrep}
	 */
	ignoreFileCaseInsensitive = (): RipGrep => {
	 ...
	 * @returns {RipGrep}
	 */
	maxFilesize = (num_suffix: string): RipGrep => {
	 ...
	 * @returns {RipGrep}
	 */
	pathSeparator = (seperator: string): RipGrep => {
	 ...
	 * @returns {RipGrep}
	 */
	regexSizeLimit = (num_suffix: string): RipGrep => {
	 ...
	 * @returns {RipGrep}
	 */
	sort = (by: 'path' | 'modified' | 'accessed' | 'created' | 'none'): RipGrep => {
	 ...
	 * @returns {RipGrep}
	 */
	sortr = (by: 'path' | 'modified' | 'accessed' | 'created' | 'none'): RipGrep => {
	 ...
	 * @returns {RipGrep}
	 */
	typeAdd = (type_spec: string): RipGrep => {
